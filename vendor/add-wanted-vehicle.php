...
if(isset($_POST['submit'])){
	...
	$insert_query = $con->query("SET NAMES utf8");
		$insert_query = "INSERT INTO wanted_vehicles(vendor_id,vehicle_number,wanted_time) VALUES('$current_user_id','$vehicle_number','$wanted_time')";
