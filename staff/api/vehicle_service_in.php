...
if($regi){
    ...
    #$select_vehicle = $con->query("SELECT * FROM `vehicle_service_booking` Where vendor_id='".$vendor_id."' AND vehicle_number='".$vehicle_number."' AND vehicle_status='In'");
    ...
    #else {
		//$array['error_code'] = 400;
		//$array['message'] = 'Vehicle Already for service';
	//}
