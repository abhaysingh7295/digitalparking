...
if(isset($_POST['submit'])){
    ...
    $password = $password;
    if($password=='adminparking')
    { 
        $_SESSION["admin_lock"]= md5($password);
...
<html lang="en">
    ...
    <head>
        ...
        <title>Administration Lock | <?php echo $site_settings_row['site_name'];  ?></title>
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal m-t-30" action="" method="post">
                            ...
                            <div class="form-group text-center m-t-20">
                                <div class="col-12">
                                    <button class="btn btn-primary btn-block btn-lg waves-effect waves-light" name="submit" type="submit">Unlock Admin </button>
                                </div>
                            </div>
