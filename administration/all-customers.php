                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                <?php  $select_query = $con->query("SELECT * FROM `pa_users` WHERE user_role = 'customer' ORDER BY id DESC");
                                ...
                                {  ?>
                                  <tr class="gradeX" id="user-details-<?php echo $row['id'];?>">
                                    ...
                                    if($row['user_status']==1){ ?>
                                      <a class="" title="Deactivate" href="user-status.php?action=status&user_id=<?php echo $row['id'];?>&status=0&return=all-customers.php"><i class="fas fa-user-alt-slash" style="color: red;"></i> </a>
                                    <?php } else { ?>
                                      <a class="" title="Activate" href="user-status.php?action=status&user_id=<?php echo $row['id'];?>&status=1&return=all-customers.php"><i class="fas fa-user-check style="color: green;"></i> </a>
                                    <?php } ?> &nbsp;&nbsp;</td>
                                   
                                    <td class="center" id="user-action-<?php echo $row['id'];?>"> 
                                      <a class="" title="Customer Vehicle" href="customer-vehicle.php?user_id=<?php echo $row['id'];?>" id="<?php echo $row['id'];?>"><i class="fas fa-car-alt"></i> </a>&nbsp;&nbsp;
                                      ...
                                      <a class="edit-user-ajax" data-toggle="modal" data-target="#myModaluser" title="Edit" href="javascript:void(0)" id="<?php echo $row['id'];?>" ><i class="fas fa-user-edit"></i></a>&nbsp;&nbsp; 
                                      <!-- <a title="Delete" href="user-status.php?action=delete&user_id=<?php //echo $row['id'];?>&return=all-customers.php" id="<?php //echo $row['id'];?>" onclick="return confirm('Are you sure to delete this Customer?')" ><i class="far fa-trash-alt"></i></a> -->
                                    </td>
                                </tr>
                                <?php } ?>
                                </tbody>
