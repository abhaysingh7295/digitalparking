...
//                        echo "<li class='page-item'><a class='page-link' href='parking-history-new.php?page=" . ($page - 1) . "$query_string' class='button'>Previous</a></li>";
//
//                        for ($i = 1; $i <= $total_pages; $i++) {
//                            echo "<li class='page-item'><a class='page-link' href='parking-history-new.php?page=" . $i . "$query_string'>" . $i . "</a></li>";
//                        };
//
//                        echo "<li class='page-item'><a class='page-link' href='parking-history-new.php?page=" . ($page + 1) . "$query_string' class='button'>NEXT</a></li>";
//                        echo "</ul>";
                        $pagLink = "<ul class='pagination abc'>";
                        for ($i = 1; $i <= $total_pages; $i++) {
                            $pagLink .= "<li class='page-item'><a class='page-link' href='parking-history-new.php?page=" . $i . "$query_string'>" . $i . "</a></li>";
                        }
                        echo $pagLink . "</ul>";
...
<!--						<ul class="pagination">
        ...
        <li class="<?php if($page <= 1){ echo 'disabled'; } ?>">
            <a href="<?php if($page <= 1){ echo 'parking-history-new.php'; } else { echo "?page=".($page - 1); } ?>">Prev</a>
        </li>
        <li class="<?php if($page >= $total_pages){ echo 'disabled'; } ?>">
            <a href="<?php if($page >= $total_pages){ echo 'parking-history-new.php'; } else { echo "?page=".($page + 1); } ?>">Next</a>
        </li>
